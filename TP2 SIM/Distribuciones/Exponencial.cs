...
namespace TP2_SIM.Distribuciones
{
    public class ExponencialNegativa
    {
        ...
        public void CalcularResultadoPruebas()
        {
            ...
            Resultados.AppendText("Siendo la hipótesis que la distribución se aproxima a una Exponencial Negativa, si asumimos un nivel de significancia de alfa = 0.05: " + "\r\n");
